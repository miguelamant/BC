...
<link rel="stylesheet" href="<?=base_url()?>\public\css\styles.css?v=3" />
<!-- Font Awesome -->
...
<div id="#top"></div>
<section id="home">
  <div class="banner-container"> <img src="<?=base_url()?>\public\images/books_background.jpg" alt="banner" />
    <div class="container banner-content">
      <div class="hero-text animated fadeInDownBig">
        <h1 class="responsive-headline" style="color:black;font-size: 40px;">Book Cycle</h1>
        <p>An interfaculty competition for second hand coursebooks <br/>
          </p>
      </div>
      
      <!-- <a class="hero-button learn-more smoothscroll text-center" href="#features">Learn More</a>-->
      <div class="hero-img"> <img src="<?=base_url()?>\public\images/goldenCup.jpeg" alt="" class="text-center animated fadeInUpBig"/></div>
    </div>
  </div>
</section>
