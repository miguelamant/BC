        ...
        <nav class="navbar navbar-inverse" role="navigation">
            ...
            <div id="main-nav" class="collapse navbar-collapse">
                <ul class="nav navbar-nav" id="mainNav">
                    <li ><a href="#home" class="scroll-link">Homer</a></li> <!-- class="active" -->
                    <!--<li><a href="#features" class="scroll-link">Features</a></li>-->
                    <li><a href="#aboutUs" class="scroll-link">Book cycle</a></li>
                    <li><a href="#services" class="scroll-link">Why?</a></li>
    ...
    <div class="banner-container"> <img src="<?=base_url()?>\public\images/stackCalculator2.jpg" alt="banner" />
        <div class="container banner-content">
            <div style="visibility: hidden"class="hero-text animated fadeInDownBig">
                <h1 class="responsive-headline" id="mainTitles" >Booooooook Cycle</h1>
            ...
            <div  class="hidden hero-img"> <img src="<?=base_url()?>\public\images/BC_logo-removebg-preview.png" alt="" class="text-center animated fadeInUpBig"/></div>
        </div>
    </div>
</section>
...
<section id="aboutUs" class="page-section "> <!--darkBg pDark-->
    <div class="container">
        <div class="heading text-center">
            <!-- Heading -->
            <h2>About Us</h2>
            <p>Attt lorem Ipsum available, but the majority have suffered alteration in some form by injected humour.</p>
        </div>
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div id="owl-demo" class="owl-carousel">
                        <div class="item"> <span class="helper"> <img src="base_images/clients/client-1.png" alt="client" /></span> </div>
